...
m_data="https://github.com/brt2cv/kaggle-data.git"

if [ $action == "push" ]; then
    # 子模块
    # subtree_push data $m_data master

    # submodule
    submodule_push data $m_data master
    ...
    # 子模块
    # subtree_pull data $m_data master

    # submodule
    submodule_pull data $m_data master
